...
func NewVerticallyScrollableTextView(frame foundation.Rect) ScrollView {
	...
	tv.SetMinSize(foundation.MakeSize(0.0, svSize.Height()))
	tv.SetMaxSize(foundation.MakeSize(foundation.SIZE_MAX, foundation.SIZE_MAX))
	tv.SetVerticallyResizable(true)
	tv.SetHorizontallyResizable(false)
	tv.SetAutoresizingMask(ViewWidthSizable)
	tv.TextContainer().SetSize(foundation.MakeSize(svSize.Width(), foundation.SIZE_MAX))
...
func NewScrollableTextView(frame foundation.Rect) ScrollView {
	...
	tv.TextContainer().SetSize(foundation.MakeSize(foundation.SIZE_MAX, foundation.SIZE_MAX))
